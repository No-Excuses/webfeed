...
class RdfFeed {
  ...
  factory RdfFeed.parse(String xmlString) {
    ...
    try {
      rootElement = document.findAllElements("rdf:RDF").first;
    } on StateError {
      throw ArgumentError("rdf:RDF not found");
    }
    ...
    return RdfFeed(
      ...
      items: rootElement.findElements("item").map((element) {
